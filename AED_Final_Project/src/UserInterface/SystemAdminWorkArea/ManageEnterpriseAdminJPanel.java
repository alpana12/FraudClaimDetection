...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        String email = emailJTextField.getName();
        String name = nameJTextField.getText();
        
       Person person = enterprise.getPersonDirectory().createPerson(name);
        
        
        if("Hospital".equals(enterprise.getEnterpriseType().toString())) {
            UserAccount account = enterprise.getUserAccountDirectory().createUserAccount(username, password, email, person, new HospitalAdminRole());
        }
        else{
                    UserAccount account = enterprise.getUserAccountDirectory().createUserAccount(username, password, email, person, new InsuranceAdminRole());
        }
     populateTable();
